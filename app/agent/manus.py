...
class Manus(ToolCallAgent):
    ...
    # 定义available_tools 属性，类型为 ToolCollection，使用 Field 定义，
    # 默认值通过 lambda 函数生成，创建了一个包含 PythonExecute、GoogleSearch、BrowserUseTool、FileSaver 和 Terminate 实例的 ToolCollection 对象，
    # 向工具集合中添加通用工具
